...
הפרויקט מתועד בשלושה מסמכים. **חובה** לקרוא את הרלוונטי לפני שינוי קוד:

| מסמך | מתי לקרוא |
|------|-----------|
| `MASTER_PRD.md` | **תמיד** — לפני כל Sprint, לפני כל החלטה ארכיטקטונית |
| `IMPLEMENTATION_PLAN.md` | כשעובדים על מודול קיים שדורש תיקון |
| `SECTOR_ANALYSIS_SPEC.md` | כל פעם שעובדים על Sector Service או Validation Gates |
