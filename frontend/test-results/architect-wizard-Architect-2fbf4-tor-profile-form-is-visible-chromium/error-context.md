...
- Name: architect-wizard.spec.ts >> Architect Wizard — 6-step flow >> step 1: investor profile form is visible
- Location: tests/e2e/architect-wizard.spec.ts:89:3
...
Locator: getByRole('heading', { name: /architect/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /architect/i })
