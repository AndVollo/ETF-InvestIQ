...
- Name: architect-wizard.spec.ts >> Architect Wizard — 6-step flow >> step 1 → step 2: start session after filling profile
- Location: tests/e2e/architect-wizard.spec.ts:95:3
